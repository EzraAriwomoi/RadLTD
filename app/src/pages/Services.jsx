          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Comprehensive training on effective committee operations
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start gap-2">
                    <CheckCircle2 className="h-5 w-5 text-green-600 mt-0.5 shrink-0" />
                    <span>
                      Obstacles that inhibit committees from realizing their
                      objectives
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Expert guidance on parliamentary rules and procedures
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Specialized training for county-level legislative bodies
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Training programs for parliamentary and assembly staff
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
      ...
      <section className="bg-gray-50 py-16 px-4">
        <div className="container mx-auto">
          ...
          <div className="max-w-3xl mx-auto text-gray-700 space-y-4">
            <p>
              At Radiance Star Legislative Consult Ltd, we believe in a
              practical, hands-on approach to legislative training. Our programs
              are designed to address real-world challenges faced by legislative
              bodies in Kenya.
            </p>
            <p>
              Our trainers have extensive experience working with both national
              and county-level legislative institutions, bringing practical
              insights and solutions to every training session.
            </p>
            <p>
              We customize our training programs to meet the specific needs of
              each client, ensuring that the content is relevant, practical, and
              immediately applicable.
            </p>
            <p>
              Our training sessions combine theoretical knowledge with practical
      ...
      <section className="bg-[#0c2340] text-white py-16 px-4">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6">
            Ready to Enhance Your Legislative Capabilities?
          </h2>
          <p className="text-lg max-w-2xl mx-auto mb-8">
            Contact us today to discuss how our expert consultants can help
            achieve your its legislative objectives.
          </p>
          <Button
            asChild
            size="lg"
